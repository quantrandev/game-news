                ...
                <div class="fashion">
                    ...
                    <div class="fashion-top">
                        <div class="fashion-left">
                            <a href="/game-news/app/pages/client/news/single.php?id=<?php echo $posts[$i]["id"]; ?>"><img
                                        src="/game-news/assets/<?php echo $posts[$i]["image"]; ?>"
                                        class="img-responsive" alt=""></a>
                            <div class="blog-poast-info">
                                <p class="fdate"><span
                                            class="glyphicon glyphicon-time"></span><?php echo date('d-m-Y - h:i:s', strtotime($post[$i]["createdAt"])); ?>
                                    <a
                                            class="span_link1" href="#"><span
                                                class="glyphicon glyphicon-comment"></span>0 </a><a
                                            class="span_link1"
                                            href="#"><span
                                                class="glyphicon glyphicon-thumbs-up"></span><?php echo $posts[$i]["views"]; ?>
                                    </a></p>
                            </div>
                            <h3>
                                <a href="/game-news/app/pages/client/news/single.php?id=<?php echo $posts[$i]["id"]; ?>"><?php echo $posts[$i]["title"]; ?></a>
                            </h3>
                            <p><?php echo $posts[$i]["summary"]; ?></p>
                            <a class="reu"
                        ...
                        <div class="fashion-right">
                            <a href="/game-news/app/pages/client/news/single.php?id=<?php echo $posts[$i + 1]["id"]; ?>"><img
                                        src="/game-news/assets/<?php echo $posts[$i + 1]["image"]; ?>"
                                        class="img-responsive" alt=""></a>
                            <div class="blog-poast-info">
                                <p class="fdate"><span
                                            class="glyphicon glyphicon-time"></span><?php echo date('d-m-Y - h:i:s', strtotime($post[$i + 1]["createdAt"])); ?>
                                    <a
                                            class="span_link1" href="#"><span
                                                class="glyphicon glyphicon-comment"></span>0 </a><a
                                            class="span_link1"
                                            href="#"><span
                                                class="glyphicon glyphicon-thumbs-up"></span><?php echo $posts[$i + 1]["views"]; ?>
                                    </a></p>
                            </div>
                            <h3>
                                <a href="/game-news/app/pages/client/news/single.php?id=<?php echo $posts[$i + 1]["id"]; ?>"><?php echo $posts[$i + 1]["title"]; ?></a>
                            </h3>
                            <p><?php echo $posts[$i + 1]["summary"]; ?></p>
                            <a class="reu"
